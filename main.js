// mensaje inicial
alert("NUESTROS PRODUCTOS. Remera / Pantalon / Short / Buzo / Camisa");
...
for (let i = 1 ; i <= limite ; i++) {
    ...
    if (prenda==null) {
        ...
        // seleccion de talle
        let talle = prompt("Ingresá el talle que buscás. (S / M / L / XL)").toUpperCase ();

        if ((talle=="S") || (talle=="M") || (talle=="L") || (talle=="XL")) {
            alert("Elegiste: " + prenda + " talle " + talle);
        }
